...
Steel blue on black."
  ...
  (color-theme-install
   '(color-theme-comidia
     ...
     (default ((t (:stipple nil :background "Black" :foreground "SteelBlue" 
		   :inverse-video nil :box nil :strike-through nil :overline nil 
		   :underline nil :slant normal :weight normal :family "misc-fixed"))))
     ...
     (header-line ((t (:box (:line-width 1 :style none) :background "grey20" :foreground "grey90" :box nil))))
     ...
     (modeline ((t (:background "Gray10" :foreground "SteelBlue" :box (:line-width 1 :style none)))))
     (modeline-buffer-id ((t (:background "Gray10" :foreground "SteelBlue" :box (:line-width 1 :style none)))))
     (modeline-mousable-minor-mode ((t (:background "Gray10" :foreground "SteelBlue" :box (:line-width 1 :style none)))))
     (modeline-mousable ((t (:background "Gray10" :foreground "SteelBlue" :box (:line-width 1 :style none)))))
